...
namespace Mango.Specifications
{
    ...
    internal sealed class AndSpecification<T, TResult> : Specification<T, TResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AndSpecification{T, TResult}" /> class.
        /// </summary>
        ...
        {
            // 1. Combine filter expressions with logical AND
            var criteria = CompositionHelpers.ComposeCriteria(left, right, ExpressionType.AndAlso);
    ...
    internal sealed class AndSpecification<T> : Specification<T>
    {
        ...
        internal AndSpecification(
            ...
            PaginationEvaluationPolicy paginationPolicy = PaginationEvaluationPolicy.None)
        {
            // 1. Combine filter expressions using logical AND
            var criteria = CompositionHelpers.ComposeCriteria(left, right, ExpressionType.AndAlso);
            Query.Where(criteria);
